    ...
    <div className="space-y-10 fade-up">
      <header className="space-y-3 text-center">
        ...
        <h1 className="font-display text-5xl sm:text-6xl tracking-tight bg-gradient-to-br from-white via-pink-200 to-pink-400 bg-clip-text text-transparent">
          poll tools, head to head
        </h1>
        <p className="text-white/60 text-balance max-w-2xl mx-auto">
          {all.length} honest 2-by-2 comparisons between moomz, Strawpoll,
          Mentimeter, Slido, Typeform, Google Forms, Doodle, Kahoot and the
          rest. Pricing, design, anonymity, share flow. Pick the right tool for
          your question.
        </p>
      </header>
      ...
      {[...byTopic.entries()].map(([topic, list]) => (
        <section key={topic} className="space-y-3">
          <h2 className="font-display text-2xl text-white capitalize">
            {topic}
          </h2>
