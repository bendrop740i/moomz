...
const fr: CosmosStrings = {
  ...
  archivesIntro: "Toutes les images astronomiques des dernières semaines.",
...
const en: CosmosStrings = {
  ...
  archivesIntro: "Every astronomy picture from the past few weeks.",
...
const es: CosmosStrings = {
  ...
  archivesIntro: "Todas las imágenes astronómicas de las últimas semanas.",
...
const it: CosmosStrings = {
  ...
  archivesIntro: "Tutte le immagini astronomiche delle ultime settimane.",
...
const pt: CosmosStrings = {
  ...
  archivesIntro: "Todas as imagens astronômicas das últimas semanas.",
...
const de: CosmosStrings = {
  ...
  archivesIntro: "Alle astronomischen Bilder der letzten Wochen.",
