...
**2026-05-20, UX/IA refonte — navigation unifiée (`28aef98`).** User: "trop le bazar" — 4 systèmes de nav qui se contredisaient, prompts install/notif empilés en bas, aucune structure d'app claire. Corrigé en une passe (3 agents parallèles + cœur à la main).
