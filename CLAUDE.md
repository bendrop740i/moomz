...
- **Reste à faire** : liens de nav internes encore vers les URLs nues (marchent via 301 — micro-optim) ; Stage 5 (contenu es/it/pt/de/ja/zh — aujourd'hui ces locales retombent sur EN/FR pour le contenu). Plan : `~/.claude/plans/fluffy-launching-rivest.md`.
