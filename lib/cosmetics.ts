...
export type CosmeticPalette = {
  ...
  c3: string;
  unlock: UnlockReq;
  // Coin-shop price. 0 = not for sale (free palettes). Buying a palette is an
  // alternative to grinding the points/streak unlock. Keep in sync with the
  // price CASE in buy_cosmetic (migration 024).
  price: number;
};
...
export const COSMETIC_PALETTES: CosmeticPalette[] = [
  { id: "auto",    name: "Auto",    c1: "#ff3d8b", c2: "#7c3aed", c3: "#f59e0b", unlock: { kind: "free" }, price: 0 },
  { id: "default", name: "Pink",    c1: "#ff3d8b", c2: "#7c3aed", c3: "#f59e0b", unlock: { kind: "free" }, price: 0 },
  { id: "ocean",   name: "Ocean",   c1: "#06b6d4", c2: "#3b82f6", c3: "#a855f7", unlock: { kind: "free" }, price: 0 },
  { id: "candy",   name: "Candy",   c1: "#f472b6", c2: "#a78bfa", c3: "#22d3ee", unlock: { kind: "points", value: 50 },   price: 200 },
  { id: "sunset",  name: "Sunset",  c1: "#ef4444", c2: "#f97316", c3: "#facc15", unlock: { kind: "points", value: 150 },  price: 350 },
  { id: "neon",    name: "Neon",    c1: "#22d3ee", c2: "#a3e635", c3: "#f0abfc", unlock: { kind: "points", value: 400 },  price: 600 },
  { id: "matrix",  name: "Matrix",  c1: "#10b981", c2: "#22c55e", c3: "#84cc16", unlock: { kind: "points", value: 1000 }, price: 1000 },
  { id: "fire",    name: "Fire",    c1: "#dc2626", c2: "#f59e0b", c3: "#fde047", unlock: { kind: "streak", value: 12 },   price: 800 },
  { id: "galaxy",  name: "Galaxy",  c1: "#7c3aed", c2: "#ec4899", c3: "#0ea5e9", unlock: { kind: "streak", value: 18 },   price: 1200 },
  { id: "gold",    name: "Gold",    c1: "#fbbf24", c2: "#f59e0b", c3: "#fde047", unlock: { kind: "points", value: 2500 }, price: 1500 },
];
...
export function isUnlocked(
  p: CosmeticPalette,
  stats: { points: number; topStreak: number; owned?: string[] | null },
): boolean {
  // Bought in the coin shop → always unlocked, regardless of points/streak.
  if (stats.owned && stats.owned.includes(p.id)) return true;
